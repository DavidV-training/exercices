...
echo "==================Lancement du nginx========================="
#docker run -d --name localhost:80/nginx -p 80:80 localhost:80/nginx
...
#echo "******reponse 200 veut dire ok*****"
#curl -I -s -o /dev/null -w "%{http_code}" localhost:80/
